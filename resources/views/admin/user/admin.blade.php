                ...
                <div class="container-xl">
                    <div class="row g-2 align-items-center">
                        <div class="col">
                            ...
                            <div class="text-muted mt-1">{{ $tiangPusat->firstItem() }}-{{ $tiangPusat->lastItem() }}
                        ...
                        <div class="col-12 col-md-auto ms-auto d-print-none">
                            <div class="d-flex">
                                <!-- Form pencarian -->
                                <form method="GET" action="{{ route('users.adalahAdmin') }}" class="d-flex">
                    ...
                    <div class="row row-cards" id="adminUsersContainer">
                        ...
                        <div class="d-flex mt-4">
                            <ul class="pagination ms-auto">
                                <!-- Previous Page Link -->
                                <li class="page-item {{ $tiangPusat->onFirstPage() ? 'disabled' : '' }}">
                                    <a class="page-link" href="{{ $tiangPusat->previousPageUrl() }}" tabindex="-1"
                                        aria-disabled="true">
                                ...
                                <!-- Page Numbers -->
                                @foreach ($tiangPusat->links()->elements[0] as $page => $url)
                                    <li class="page-item {{ $page == $tiangPusat->currentPage() ? 'active' : '' }}">
                                        <a class="page-link" href="{{ $url }}">{{ $page }}</a>
                                    </li>
                                @endforeach

                                <!-- Next Page Link -->
                                <li class="page-item {{ $tiangPusat->hasMorePages() ? '' : 'disabled' }}">
                                    <a class="page-link" href="{{ $tiangPusat->nextPageUrl() }}">
                                        selanjutnya
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
